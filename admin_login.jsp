  ...
  <br>
        <form method="post" action="admin_login">
            <div class="row"style="margin-top:100px;">
                ...
                <h1>
                    <br>
                     <span style="color: black"></span><span style="color: steelblue"></span>
                     <span style="color: black"></span><span style="color: steelblue"></span>
                    <span style="color: black"></span><span style="color: steelblue"></span>
                </h1>
        ...
        <div class="subdiv">
            ...
            <h1 class="heading">Admin login Form</h1>
            </div></div>
                <br>
                    <div class="maindiv">       
            <input class="textbox" type="text" name="uid" placeholder="Admin-Id" >
            ...
            <input type="submit"  value="Log In" name="submit" class="button1">
                 <br>
                 <input type="submit"  value="Sign Up" name="submit" class="button1">
                 <br>
