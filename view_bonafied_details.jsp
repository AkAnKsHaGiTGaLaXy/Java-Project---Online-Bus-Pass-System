         ...
         <header id="header" class="fixed-top d-flex align-items-center">     
            <div class="container d-flex align-items-center">       
                ...
                <nav id="navbar" class="navbar order-last order-lg-0">         
                    <ul>           
                        <li><a class="nav-link scrollto active" href="college_home.jsp">Home</a></li>           
                        <li><a class="nav-link scrollto" href="view_bonafide_request.jsp">Bonafide Request</a></li>           
                        <li><a class="nav-link scrollto" href="bonafide_list.jsp">Bonafide Assigned</a></li>       
                        
                                          
                    </ul>         <i class="bi bi-list mobile-nav-toggle"></i>      
                </nav><!-- .navbar -->       
                
                <a href="college_login.jsp" class="get-started-btn scrollto">Logout</a>     
            </div>   
        </header>
...
%>
                    <form method="post" action="view_bonafide_details">
                    <div class="col-sm-7">
                <div class="row">
                    <div class="col-sm-1"></div>
                    <div class="col-sm-3">
                       <label  class="pass">Request ID : <%=id%></label> <br> 
                    </div>
                    <div class="col-sm-3">
                 ...
                 <input class="details" type="text" name="passno" placeholder="Assign Bonfide Number">
