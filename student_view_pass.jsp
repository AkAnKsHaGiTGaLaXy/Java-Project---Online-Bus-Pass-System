...
<%
    ...
    String sql = "select * from student_apply_pass where id='"+session.getAttribute("id") +"' ";
...
%>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-3">
                       <label  class="pass"><%=period%></label> <br> 
                    </div>
                    <div class="col-sm-3">
                    ...
                    <div class="col-sm-6">
                       <label  class="pass">Pass Number: <%=passno%></label> <br> 
                    </div>
                </div>
                 ...
                 <input class="details" type="text" name="adhar_number" placeholder="" value="<%=adhar_number%>" disabled=""><br>
                 <input class="details" type="text" name="admission_reciept" placeholder="" value="<%=admission_reciept%>" disabled="">
                 <input class="details" type="text" name="bonafide_number" placeholder="" value="<%=bonafide_number%>" disabled="">
                 <input class="details" type="text" name="route" placeholder="" value="<%=route%>" disabled="">
                  <input class="details" type="text" name="period" placeholder="" value="<%=period%>" disabled="">
                 
                    </div>
                    <div class="col-sm-4">
                        <div style="height: 300px; width: 300px; background-image: url('Image/<%=photo%>'); background-size: cover; margin-top: 80px;"></div>
                        <input class="detail" type="text" name="status" placeholder="" value="<%=status%>" disabled=""> 
    ...
    <form method="post" action="Report_View.jsp"> 
        ...
        <input type="submit"  value="Print" name="submit" class="button1"> 
    </form>
  <%
