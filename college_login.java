 ...
 */
public class college_login extends HttpServlet {
    Connection cn = null;
    Statement st = null;
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        if(event.equals("Log In"))
        {
           ...
           else
           {
               try
               {
                   ...
                   String sql = "select * from college_signup where uid = '"+uid.toString()+"' and pass = '"+pass.toString()+"' ";
                   ...
                   if(rs.next())
                   {
                       ...
                       out.println("location='college_home.jsp';");
                       out.println("</script>");
        ...
        {
          resp.sendRedirect("college_signup.jsp");
        }
