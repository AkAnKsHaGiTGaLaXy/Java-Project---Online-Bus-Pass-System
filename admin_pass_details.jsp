                ...
                <div class="row">
                 ...
                 <input class="details" type="text" name="route" placeholder="" value="<%=route%>" disabled="">
                    ...
                    <div class="col-sm-4">
                        ...
                        <select name="status" class="detail">
                            <option>Pending</option>
                            <option>Confirm</option>
                            <option>Reject</option>
                        </select>
                        <input class="detail" type="text" name="passno" placeholder="Assign Pass Number" style="width: 200px;" >
                        
                        <input class="button1" type="submit" name="submit" value="Update Details">
                    </div>
