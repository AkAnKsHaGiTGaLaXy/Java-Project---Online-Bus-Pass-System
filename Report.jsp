...
<html>
    ...
    <div class="container d-flex align-items-center">
      ...
      <nav id="navbar" class="navbar order-last order-lg-0">
        <ul>
          ...
          <li><a class="nav-link scrollto" href="Report.jsp">Reports</a></li>
        </ul>
  ...
  <form action="Report_View.jsp">
        ...
        <div class="subdiv">
            ...
            <input type="submit"  value="Pass" name="submit" class="button1">     
            <input type="submit"  value="Student Bonafide List" name="submit" class="button1">
            <input type="submit"  value="Pending Pass" name="submit" class="button1">
            <input type="submit"  value="Confirm Pass" name="submit" class="button1">
