        ...
        *h1, table { text-align: center; width: 100%; }
        ...
        <header id="header" class="fixed-top d-flex align-items-center">     
            ...
            <a href="#" class="back-to-top d-flex align-items-center justify-content-center">
                ...
                <div class="box">
            <h1 align="center">BONAFIDE STATUS</h1>
...
<%
    ...
    String sql = "select * from student_apply_bonafide where status='Confirm' or status='Reject'  ";
...
%>
     ...
     <form method="post" action="view_bonafide_request">
    <tr>
