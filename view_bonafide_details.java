 ...
 */
public class view_bonafide_details extends HttpServlet {
   ...
   Connection cn = null;
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
         ...
         if(event.equals("Update Details"))
        {
                ...
                session.setAttribute("bonafide_number",passno);
                
                String update = db.update("update student_apply_bonafide set status='"+status.toString()+"', bonafide_number='"+passno.toString()+"' where id='"+id.toString()+"' && student_id='"+student_id+"' ");
                out.println(update);
                resp.setContentType("text/html");
                out.println("<script type=\"text/javascript\">");  
                out.println("alert('Status updated to "+status+"');");
                out.println("location='view_bonafide_request.jsp';");
                out.println("</script>");
          }
