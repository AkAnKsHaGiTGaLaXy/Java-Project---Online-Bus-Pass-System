...
<html>
  ...
  <br><br><br><br><br><br><br>
        ...
        <div class="row1">
            <br><br>
            <h2 align="center">Admin Sign-Up Form</h2>
            <br></div>
            <div class="row2">
            <div class="col-sm-6">
                <br>  
                <input class="box" type="text" name="fname" placeholder="Full Name" onkeypress="return isString(event)">
                <br><br><br>
            ...
            <div class="col-sm-6">
                <br>
                <input class="box" type="text" name="uid" placeholder="Admin-Id" required="">
                <br><br><br>
